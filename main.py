...
def predict_model(image):
    ...
    # Loop through each detected box and draw a rectangle
    ...
    plt.savefig('output_image.png')  # You can change the filename and format as needed
    plt.close()
    return 'output_image.png', class_names
...
# model.save("modelo_retinaNet.h5")
# model.save_weights("prueba")